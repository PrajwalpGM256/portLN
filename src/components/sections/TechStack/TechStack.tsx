...
export function TechStack() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div ref={headerRef} className="site-container mb-12 md:mb-28 lg:mb-36 pb-6 md:pb-12 lg:pb-16">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 lg:gap-16">
          {/* Left side - Title */}
          <div className="lg:max-w-xl">
            <motion.h2
              className="text-3xl md:text-6xl lg:text-7xl font-black tracking-tighter leading-[0.9]"
      ...
      {/* ==================== MOBILE VIEW - Category Accordion ==================== */}
      <div className="md:hidden site-container pb-12">
        <MobileTechStack techStack={techStack} />
      </div>

      {/* ==================== DESKTOP VIEW - Grid with Flip Cards ==================== */}
      <div className="hidden md:block site-container overflow-hidden py-16">
        <div
          ref={gridRef}
