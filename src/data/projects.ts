...
export const projects: Project[] = [
  ...
  id: "mini-emr",
  title: "Mini-EMR",
  description: "Electronic medical records system with separate admin and patient portals, JWT auth, and a glassmorphism UI",
  highlights: ["Role-based access", "Appointment scheduling", "Framer Motion animations"],
  tech: ["Next.js", "TypeScript", "Prisma", "PostgreSQL", "Tailwind CSS", "shadcn/ui"],
  category: "Healthcare",
  year: "2026",
  color: "#8b5cf6",
  github: "https://github.com/PrajwalpGM256/mini-EMR",
